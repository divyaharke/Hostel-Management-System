...
String dno=a1.getText();
  String city=a2.getText();
   ...
   else if(gender.length()==0)
{
    ...
    else if(dno.length()==0)
{
    JOptionPane.showMessageDialog(null,"invlaid House number");
}
...
st=con.createStatement(); 
 st.executeUpdate("insert into student values("+id+",'"+name+"','"+fname+"',"+age+",'"+hname+"','"+gender+"',"+ mob+",'"+dat+"')");
