...
public class Updation1 extends JFrame implements ActionListener
 { 
JLabel l1,l2,l3,l6,l7,l9;
...
String an=a1.getText();
  String as=a2.getText();
...
//st.executeQuery("update table student set hname=?,mob=?");

String sql="update student set hname=? and mob=? where id=? ";
