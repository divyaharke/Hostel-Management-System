...
states[32] = "Delhi";
states[33] = "Lakshadeep"; "Pondicherry";
ch2.add("TamilNadu");
 ch2.add("Karnataka"); 
ch2.add("Maharashtra"); */
...
b2=new JButton("Cancel");
 b2.setBounds(290,450,100,25);
 b3=new JButton("Clear"); 
b3.setBounds(430,450,100,25); 
b4=new JButton("Report");
b4.setBounds(570,450,100,25);
...
else if(sst.equals("Report"))
{
int r=0;
	try
	{
	Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
	 Connection con=DriverManager.getConnection("jdbc:odbc:acdsn");
       Statement stmt=con.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
	ResultSet rs=stmt.executeQuery("select * from student");
	while(rs.next())
	{
//	model.insertRow(r++,new Object[] {rs.getInt(1),rs.getString(2),rs.getString(3),rs.getString(4),rs.getString(5),rs.getString(6),rs.getString(7),rs.getString(8)});
	}
	}
	catch(Exception ex)
	{
